...
<body>
    <div class="result-container">
        <h1>Quiz Results</h1><hr>
        <%
            String student = request.getParameter("StudentTable");
            String tableName = request.getParameter("tableName");
            String resultTableName = student.replaceAll("@", "_").replaceAll("\\.", "_") + "_" + tableName;
                out.print("<b>Email: </b>"+student);
                out.print("<br><b>Subject: </b>"+tableName+"");
        ...
        %>
                    <div class="question">
                        <strong><br>Q:</strong> <%= question %><br>
                        A. <%= opt1 %><br>
                        B. <%= opt2 %><br>
                        C. <%= opt3 %><br>
                        D. <%= opt4 %><br>
        ...
        <%
                ...
                out.println("<p>Student did not give this quiz</p>");
            }
        %>
        <hr>
        <p><strong>Score:</strong> <%= correctCount %> out of <%= totalQuestions %> questions correct.</p>
    </div>
</body>
</html>
