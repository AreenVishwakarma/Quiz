...
<body>
    ...
    <div class="login-box">
        ...
        <form action="admin.jsp" method="post">
            <input type="text" name="username" placeholder="Admin Username" required id="eamil"><br>
    ...
    <%
        if("POST".equalsIgnoreCase(request.getMethod())){
            ...
            try{
                ...
                String check = "select * from admin where email=? and password=?";
                PreparedStatement ps = con.prepareStatement(check);
                    ...
                    if(rs.next()){
                        ...
                        sess.setAttribute("StEmail", email);    //  sending to AdminDashboard.jsp
